...
* **Physics-Based Movement & Collision**: Implemented clean NavMesh AI navigation combined with rigid physics constraints, ensuring enemies never clip through the player.
* **UI Anti-Clickthrough**: Production-ready event system preventing weapon fire or aiming logic when interacting with menus.
* **Visual Juice**: Enhanced with a custom URP Post-Processing profile featuring neon Bloom, high-contrast Color Grading, and artistic Vignette, combined with spatial 3D audio.
